...
### Please make sure that you have already finished the installation part from <a href="https://github.com/omarXzain/LTUC-ASAC/blob/main/Computer%20Setup%20Guide/installation%20tutorial.md">Here</a> in order to continue to Java part. if you do, then you can move to the next step.
